...
export function ThemeToggle() {
  ...
  return (
    <motion.div
      ...
      className="my-1 inline-flex w-full max-w-[11.5rem] items-center rounded-full border border-slate-300/70 bg-white/70 p-1 text-xs font-medium shadow-md backdrop-blur dark:border-white/15 dark:bg-slate-900/70 dark:text-slate-100 sm:text-sm"
